...
<div class="card shadow-sm w-100">
    <div class="card-body">
        <form action="{{ route('nurse.visits.store') }}" method="POST" class="row g-3">
            ...
            {{-- Other Reason --}}
            <div class="col-md-12 @if(old('reason')=='other') d-block @else d-none @endif" id="otherReasonField">
            ...
            {{-- Referred To --}}
            <div class="col-md-12 @if(old('status')=='referred') d-block @else d-none @endif" id="referredToField">
